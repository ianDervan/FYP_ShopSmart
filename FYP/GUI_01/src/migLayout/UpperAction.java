...
public class UpperAction extends SwingWorker<Object, Object>{
	...
	protected Object doInBackground() throws Exception {
		...
		mg.buttUpperCase.setEnabled(false);
		...
		try{
			...
			for(int i = 0; i < firstFile.size(); i++){
				mg.displayTextMain.append(firstFile.get(i).toUpperCase() + " ");
			}
